...
def proxy_call(proxy_mode, func, args, kwargs):
    ...
    with proxy_mode:
        if func in [aten.rand.default]:
            ...
            torch.cuda.set_rng_state(new_rng_state)
            return r
    ...
    def get_seed_offset(cls, shape):
        ...
        with disable_proxy_modes_tracing():
            with disable_fake_tensor_mode_tracing():
                ...
                return int(seed), int(offset), PhiloxRandomState.create_rng_state_tensor(seed, offset + offset_jump)
